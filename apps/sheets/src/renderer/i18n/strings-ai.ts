...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiNotLoggedIn: '未登录（AI 功能需要使用 ChatGPT 登录 账号）',
    aiWaitingBrowserLogin: '等待浏览器登录…',
    aiLoginGenspark: '使用 ChatGPT 登录',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '保存',
    aiUnknownError: '未知错误',
  ...
  en: {
    ...
    aiGskLoginBtn: 'Sign in with ChatGPT',
    ...
    aiGensparkAccount: 'ChatGPT account',
    aiAccountChecking: 'Checking…',
    aiLoggedIn: 'Signed in',
    aiLoggedInAs: 'Signed in: {email}',
    aiNotLoggedIn: 'Not signed in (AI features require a ChatGPT account)',
    aiWaitingBrowserLogin: 'Waiting for browser sign-in…',
    aiLoginGenspark: 'Sign in with ChatGPT',
    aiModel: 'Model',
    aiCancel: 'Cancel',
    aiSave: 'Save',
  ...
  'zh-TW': {
    ...
    aiNotLoggedIn: '未登入（AI 功能需要使用 ChatGPT 登入 帳號）',
    aiWaitingBrowserLogin: '等待瀏覽器登入…',
    aiLoginGenspark: '使用 ChatGPT 登入',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '儲存',
    aiUnknownError: '未知錯誤',
