...
export const strings = {
  zh: {
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '刷新',
    cloudLoginHint: '使用 ChatGPT 登录 账号，查看你在网页端创建的项目。',
    cloudEmpty: '还没有网页端项目。',
    ...
    account: '账号',
    login: '登录',
    loginGenspark: '使用 ChatGPT 登录 账号',
    loggedIn: '已登录',
    loggedInGenspark: '已使用 ChatGPT 登录',
  ...
  en: {
    ...
    cloudLoginHint: 'Sign in to your ChatGPT account to see projects you created on the web.',
  ...
  'zh-TW': {
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '重新整理',
    cloudLoginHint: '使用 ChatGPT 登入 帳號，查看你在網頁端建立的專案。',
    cloudEmpty: '還沒有網頁端專案。',
    ...
    account: '帳號',
    login: '登入',
    loginGenspark: '使用 ChatGPT 登入 帳號',
    loggedIn: '已登入',
    loggedInGenspark: '已使用 ChatGPT 登入',
